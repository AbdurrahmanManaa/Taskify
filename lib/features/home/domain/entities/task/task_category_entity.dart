...
List<Map<String, dynamic>> predefinedTaskCategories(BuildContext context) {
  return [
    {
      'name': S.of(context).predefinedCategoriesWork,
      'icon': Icons.work,
      'color': Color(0xff000080),
    },
    {
      'name': S.of(context).predefinedCategoriesPersonal,
      'icon': Icons.person,
      'color': Color(0xffADD8E6),
    },
    {
      'name': S.of(context).predefinedCategoriesHealth,
      'icon': Icons.favorite,
      'color': Color(0xff98FF98),
    },
    {
      'name': S.of(context).predefinedCategoriesFinance,
      'icon': Icons.wallet,
      'color': Color(0xffFFD700),
    },
    {
      'name': S.of(context).predefinedCategoriesFamily,
      'icon': Icons.calendar_month,
      'color': Colors.teal,
    },
    {
      'name': S.of(context).predefinedCategoriesShopping,
      'icon': Icons.shopping_bag,
      'color': Color(0xffFF7F50),
    },
    {
      'name': S.of(context).predefinedCategoriesEducation,
      'icon': Icons.school,
...
const Map<String, int> customMaterialIcons = {
  'abc': 0xf04b6,
